...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   render: () => (/* binding */ render),\n/* harmony export */   section: () => (/* binding */ section)\n/* harmony export */ });\n/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ \"./src/modules/api.js\");\n/* harmony import */ var _popupHandler_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./popupHandler.js */ \"./src/modules/popupHandler.js\");\n/* harmony import */ var _likes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./likes.js */ \"./src/modules/likes.js\");\n/* harmony import */ var _movieCounter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./movieCounter.js */ \"./src/modules/movieCounter.js\");\n/* eslint-disable import/no-cycle */\r\n\r\n\r\n\r\n\r\n\r\nconst section = document.querySelector('section');\r\nconst genreArray = ['boys'];\r\n\r\nconst render = async () => {\r\n  await Promise.all(genreArray.map((genre) => (0,_api_js__WEBPACK_IMPORTED_MODULE_0__.getMovies)(genre)));\r\n\r\n  _api_js__WEBPACK_IMPORTED_MODULE_0__.movies.forEach((obj) => {\r\n    const value = 0;\r\n    const container = document.createElement('div');\r\n    container.className = 'container';\r\n    container.setAttribute('id', obj.show.id);\r\n    container.innerHTML = `<img class='image' src=${obj.show.image.medium} alt=\"${obj.show.name}\"><h3>${obj.show.name}</h3><div class='reactions'><div><i id=${obj.show.id} class='fa fa-heart'></i><span class='likes' id=${obj.show.id}>${value}</span></div></div><button id=${obj.show.id} class='comments'>Comments</button>`;\r\n    (0,_likes_js__WEBPACK_IMPORTED_MODULE_2__.showLike)();\r\n    section.appendChild(container);\r\n\r\n    const hearts = document.querySelectorAll('.fa-heart');\r\n    hearts.forEach((heart) => {\r\n      heart.addEventListener('click', _likes_js__WEBPACK_IMPORTED_MODULE_2__.likes);\r\n    });\r\n    const comments = document.querySelectorAll('.comments');\r\n    comments.forEach((comment) => comment.addEventListener('click', _popupHandler_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]));\r\n  });\r\n  (0,_movieCounter_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(_api_js__WEBPACK_IMPORTED_MODULE_0__.movies);\r\n};\r\n\n\n//# sourceURL=webpack://webpack-setup/./src/modules/render.js?");
